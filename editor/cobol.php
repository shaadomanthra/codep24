...
<main role="main" class="flex-shrink-0">
  ...
  A basic Cobol program to print 'Hello World' message
</div>
    <form action="../index.php" method="post"><textarea id="c-code" name="code">       IDENTIFICATION DIVISION.
       PROGRAM-ID. hello.
    ...
    <input type="hidden" name="lang" value="cobol" />
