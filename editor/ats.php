...
<main role="main" class="flex-shrink-0">
  ...
  A basic ATS program to print 'Hello World' message
</div>
    <form action="../index.php" method="post"><textarea id="c-code" name="code">implement main0 () = print"Hello World!\n"</textarea>
    <input type="hidden" name="hash" value="krishnateja" />
    <input type="hidden" name="lang" value="ats" />
