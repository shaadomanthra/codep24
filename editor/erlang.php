...
<main role="main" class="flex-shrink-0">
  ...
  A basic Erlang program to print 'Hello World' message
</div>
    <form action="../index.php" method="post"><textarea id="c-code" name="code">% escript will ignore the first line
